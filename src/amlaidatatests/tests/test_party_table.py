...
from amlaidatatests.io import get_table_name, get_valid_region_codes
from amlaidatatests.schema.v1.common import entity_columns, get_entity_mutation_tests, get_entity_tests, non_nullable_fields
...
TABLE = ibis.table(party_schema, name=get_table_name("party"))
