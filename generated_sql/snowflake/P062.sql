...
FROM (
  SELECT
    COUNT(DISTINCT IFF("t1"."type" = 'AML_SUSPICIOUS_ACTIVITY_START', "t1"."concat", NULL)) AS "value_cnt",
    COUNT(DISTINCT IFF("t1"."type" = 'AML_SUSPICIOUS_ACTIVITY_END', "t1"."concat", NULL)) AS "group_count"
  FROM (
    SELECT
