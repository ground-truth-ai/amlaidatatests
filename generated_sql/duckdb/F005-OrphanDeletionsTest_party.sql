...
FROM (
  ...
  FROM (
    SELECT
      ...
      LAG("t0"."validity_start_time") OVER (PARTITION BY "t0"."party_id" ORDER BY "t0"."validity_start_time" ASC ROWS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING) AS "previous_row_validity_start_time"
